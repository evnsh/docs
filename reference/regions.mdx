---
title: 'Crab Technologies Regions'
sidebarTitle: 'Regions'
description: 'Physical Crab Technologies points of presence'
---

Regions are physical points of presence where you can host and use Crab Technologies services.
Some Crab Technologies products allow you to use multiple regions at once, some automatically
utilize all regions.

## Regions

| Region ID | Location          | Hostname Base    | Subnet Base | Upstream ISP         | Peering            |
| --------- | ------------------| ---------------- | ----------- | -------------------- | ------------------ |
| CDG1      | Paris, FR         | cdg1.as44658.net | 10.1.0.0/16 | The Constant Company | -                  |
| NCE1      | Nice,  FR         | nce1.as44658.net | 10.2.0.0/16 | -                    | -                  |
| MCI1      | Kansas City, US   | mci1.as44658.net | 10.3.0.0/16 | Rozint Ltd Co        | IX & PNI available |
| MAN1      | Manchester, UK    | man1.as44658.net | 10.4.0.0/16 | 27Fibre Ltd          | -                  |
| BCN1      | Barcelona, ES     | bcn1.as44658.net | 10.5.0.0/16 | iFog GmbH            | IX available       |
